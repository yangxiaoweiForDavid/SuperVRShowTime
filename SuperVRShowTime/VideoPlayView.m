...
{
    NSArray *array = [[NSBundle mainBundle] loadNibNamed:@"VideoPlayView" owner:nil options:nil];
...
//    [_videoPlayerView loadFromUrl:[NSURL fileURLWithPath:path] ofType:kGVRVideoTypeMono];
...
- (NSString *)stringWithCurrentTime:(NSTimeInterval)currentTime duration:(NSTimeInterval)duration
{
    ...
    NSString *durationString = [NSString stringWithFormat:@"%02d:%02d", dMin, dSec];
    NSString *currentString = [NSString stringWithFormat:@"%02d:%02d", cMin, cSec];
