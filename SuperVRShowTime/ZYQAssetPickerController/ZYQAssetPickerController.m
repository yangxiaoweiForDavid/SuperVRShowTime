...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==ceil(self.assets.count*1.0/columns)) {
        ...
        if (_numberOfVideos == 0){
            NSString *mstr = [NSString stringWithFormat:@"%d",(int)_numberOfPhotos];
            title = [NSString stringWithFormat:@"%@ 张照片",mstr];
        }
        else if (_numberOfPhotos == 0){
            NSString *mstr = [NSString stringWithFormat:@"%d",(int)_numberOfVideos];
            title = [NSString stringWithFormat:@"%@ 部视频",mstr];
        }
        else{
            NSString *mstr = [NSString stringWithFormat:@"%d",(int)_numberOfPhotos];
            NSString *title1 = [NSString stringWithFormat:@"%@ 张照片",mstr];;
            NSString *mstr2 = [NSString stringWithFormat:@"%d",(int)_numberOfVideos];
            NSString *title2 = [NSString stringWithFormat:@"%@ 部视频",mstr2];
...
- (void)setTitleWithSelectedIndexPaths:(NSArray *)indexPaths
{
    ...
    NSString *count = [NSString stringWithFormat:@"%d",(int)indexPaths.count];
    NSString *items = [NSString stringWithFormat:@"已选择 %@ 个项目",count];
    NSString *photos = [NSString stringWithFormat:@"已选择 %@ 张照片",count];
    NSString *video = [NSString stringWithFormat:@"已选择 %@ 部视频",count];
...
- (NSString *)accessibilityLabel
{
    ...
    NSString *mstr = [NSString stringWithFormat:@"%d",(int)[self.assetsGroup numberOfAssets]];
    NSString *title = [NSString stringWithFormat:@"%@ 张照片",mstr];
    return [label stringByAppendingString:title];
}
